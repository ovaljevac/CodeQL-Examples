...
namespace DemoApp
{
    class Calculator
    {
        ...
        // 1) Beskonačna petlja (nema break/return/throw/promjene stanja)
        ...
        // 2) Varijabla deklarisana ali se ne koristi (unused local)
        ...
        // 3) Potencijalni NullReference (korištenje bez provjere)
        ...
        // 4) Parametar koji se ne koristi
        public void PrintFixedMessage(string message)
        {
            Console.WriteLine("Hello!"); // message se ne koristi
        }

        // 5) "Shadowing" lokalne varijable (zbunjujuće, kvalitativna greška)
        private int total = 0;
